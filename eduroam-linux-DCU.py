...
Config.instname = "Dublin City University"
Config.profilename = "DCU eduroam"
Config.url = "http://eduroam.dcu.ie"
Config.email = "iss.servicedesk@dcu.ie"
Config.title = "eduroam CAT"
Config.servers = ['DNS:idp-wireless.dcu.ie']
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.server_match = 'idp-wireless.dcu.ie'
...
"""
Config.anonymous_identity = 'anonymous@dcu.ie'
